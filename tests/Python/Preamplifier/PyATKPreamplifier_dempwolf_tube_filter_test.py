...
from ATK.Preamplifier import DoubleDempwolfTriodeFilter
...
def filter_32(input):
  ...
  overdrivefilter = DoubleDempwolfTriodeFilter.build_standard_filter()
...
def dempwolf_32_test():
  ...
  ref = np.fromfile(dirname + os.sep + "output_tube_32d.dat", dtype=np.float64).reshape(1, -1)
  out = filter_32(x)
...
if __name__ == "__main__":
  ...
  out = filter_32(d)
  out.tofile("output_tube_32d.dat")
  out = filter_16(d)
  out.tofile("output_tube_16d.dat")
  out = filter_8(d)
  out.tofile("output_tube_8d.dat")
  out = filter_4(d)
  out.tofile("output_tube_4d.dat")
