...
def koren_32_test():
  ...
  ref = np.fromfile(dirname + os.sep + "output_tube_32k.dat", dtype=np.float64).reshape(1, -1)
  out = filter_32(x)
...
if __name__ == "__main__":
  ...
  out = filter_32(d)
  out.tofile("output_tube_32k.dat")
  out = filter_16(d)
  out.tofile("output_tube_16k.dat")
  out = filter_8(d)
  out.tofile("output_tube_8k.dat")
  out = filter_4(d)
  out.tofile("output_tube_4k.dat")
