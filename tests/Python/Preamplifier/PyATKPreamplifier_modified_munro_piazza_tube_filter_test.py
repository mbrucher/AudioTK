...
from ATK.Preamplifier import DoubleModifiedMunroPiazzaTriodeFilter
...
def filter_32(input):
  ...
  overdrivefilter = DoubleModifiedMunroPiazzaTriodeFilter.build_standard_filter()
...
def modified_munro_piazza_32_test():
  import numpy as np
  ...
  ref = np.fromfile(dirname + os.sep + "output_tube_32mmp.dat", dtype=np.float64).reshape(1, -1)
  out = filter_32(x)
...
if __name__ == "__main__":
  ...
  out = filter_32(d)
  out.tofile("output_tube_32mmp.dat")
  out = filter_16(d)
  out.tofile("output_tube_16mmp.dat")
  out = filter_8(d)
  out.tofile("output_tube_8mmp.dat")
  out = filter_4(d)
  out.tofile("output_tube_4mmp.dat")
