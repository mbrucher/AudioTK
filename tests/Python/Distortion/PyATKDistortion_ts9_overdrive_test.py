...
from ATK.Distortion import DoubleTS9OverdriveFilter
...
def ts9_32_test():
  ...
  x = np.fromfile(dirname + os.sep + "input_ts9.dat", dtype=np.float64).reshape(1, -1)
  ref = np.fromfile(dirname + os.sep + "output32_ts9.dat", dtype=np.float64).reshape(1, -1)
  out = filter_32(x)
...
def ts9_16_test():
  ...
  x = np.fromfile(dirname + os.sep + "input_ts9.dat", dtype=np.float64).reshape(1, -1)
  ref = np.fromfile(dirname + os.sep + "output16_ts9.dat", dtype=np.float64).reshape(1, -1)
  out = filter_16(x)
  assert_almost_equal(out, ref)
...
def ts9_8_test():
  ...
  x = np.fromfile(dirname + os.sep + "input_ts9.dat", dtype=np.float64).reshape(1, -1)
  ref = np.fromfile(dirname + os.sep + "output8_ts9.dat", dtype=np.float64).reshape(1, -1)
  out = filter_8(x)
  assert_almost_equal(out, ref)
...
def ts9_4_test():
  ...
  x = np.fromfile(dirname + os.sep + "input_ts9.dat", dtype=np.float64).reshape(1, -1)
  ref = np.fromfile(dirname + os.sep + "output4_ts9.dat", dtype=np.float64).reshape(1, -1)
  out = filter_4(x)
  assert_almost_equal(out, ref)
...
if __name__ == "__main__":
  ...
  d.tofile("input_ts9.dat")
  out = filter_32(d)
  out.tofile("output32_ts9.dat")
  out = filter_16(d)
  out.tofile("output16_ts9.dat")
  out = filter_8(d)
  out.tofile("output8_ts9.dat")
  out = filter_4(d)
  out.tofile("output4_ts9.dat")
