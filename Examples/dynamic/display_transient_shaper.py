...
fastattackreleasefilter.set_attack(np.exp(-1/(sampling_rate*2e-3)))
fastattackreleasefilter.set_release(np.exp(-1/(sampling_rate*100.e-3)))
...
slowattackreleasefilter.set_release(np.exp(-1/(sampling_rate*100.e-3)))
