...
from ATK.EQ import DoubleButterworthLowPassFilter, DoubleSD1ToneFilter
...
def filter_32(input):
  ...
  tonefilter.set_input_sampling_rate(48000 * 32)
  tonefilter.set_input_port(0, lowpassfilter, 0)
  tonefilter.set_tone(0)
  ...
  decimationfilter.set_input_port(0, tonefilter, 0)
...
def filter_16(input):
  ...
  lowpassfilter.set_input_port(0, overdrivefilter, 0)
  tonefilter = DoubleSD1ToneFilter()
  tonefilter.set_input_sampling_rate(48000 * 16)
  tonefilter.set_input_port(0, lowpassfilter, 0)
  tonefilter.set_tone(0)
  decimationfilter = DoubleDecimationFilter(1)
...
def filter_8(input):
  ...
  lowpassfilter.set_input_port(0, overdrivefilter, 0)
  tonefilter = DoubleSD1ToneFilter()
  tonefilter.set_input_sampling_rate(48000 * 8)
  tonefilter.set_input_port(0, lowpassfilter, 0)
  tonefilter.set_tone(0)
  decimationfilter = DoubleDecimationFilter(1)
...
def filter_4(input):
  ...
  lowpassfilter.set_input_port(0, overdrivefilter, 0)
  tonefilter = DoubleSD1ToneFilter()
  tonefilter.set_input_sampling_rate(48000 * 4)
  tonefilter.set_input_port(0, lowpassfilter, 0)
  tonefilter.set_tone(0)
  decimationfilter = DoubleDecimationFilter(1)
