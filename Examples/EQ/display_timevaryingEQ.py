...
def filter(input, blend=0, feedback=0, feedforward=1):
  ...
  noisefilter = DoubleCachedSinusGeneratorFilter(10, 1)
  noisefilter.set_input_sampling_rate(sample_rate)
  noisefilter.set_offset(1e3)
  noisefilter.set_volume(5e2)
  
  lowfilter = DoubleTimeVaryingLowPassCoefficientsIIRFilter()
  lowfilter.set_input_sampling_rate(sample_rate)
  lowfilter.set_min_frequency(500)
  lowfilter.set_max_frequency(1500)
  lowfilter.set_number_of_steps(500)
