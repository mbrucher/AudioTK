...
namespace ATK
{
  ...
  ATKProperty(Chebyshev1LowPassCoefficients<float>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(Chebyshev1LowPassCoefficients<float>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1LowPassCoefficients<double>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(Chebyshev1LowPassCoefficients<double>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1HighPassCoefficients<float>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(Chebyshev1HighPassCoefficients<float>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1HighPassCoefficients<double>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(Chebyshev1HighPassCoefficients<double>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1BandPassCoefficients<float>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1BandPassCoefficients<double>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1BandStopCoefficients<float>, ripple, get_ripple, set_ripple);
  ATKProperty(Chebyshev1BandStopCoefficients<double>, ripple, get_ripple, set_ripple);
}
