...
namespace ATK
{
  ...
  ATKProperty(BesselLowPassCoefficients<float>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(BesselLowPassCoefficients<double>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(BesselHighPassCoefficients<float>, cut_frequency, get_cut_frequency, set_cut_frequency);
  ATKProperty(BesselHighPassCoefficients<double>, cut_frequency, get_cut_frequency, set_cut_frequency);
}
