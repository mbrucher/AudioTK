...
PYBIND11_PLUGIN(PythonDistortion) {
  ...
  populate_Filter<SD1OverdriveFilter<float>>(m, "FloatSD1OverdriveFilter", f1);
  populate_Filter<SD1OverdriveFilter<double>>(m, "DoubleSD1OverdriveFilter", f2);
  ...
  populate_Filter<TS9OverdriveFilter<float>>(m, "FloatTS9OverdriveFilter", f1);
  populate_Filter<TS9OverdriveFilter<double>>(m, "DoubleTS9OverdriveFilter", f2);
