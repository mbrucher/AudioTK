...
namespace ATK
{
  ...
  template<typename DataType_>
  void CachedCosinusGeneratorFilter<DataType_>::set_frequency(int periods, int seconds = 1)
  {
  ...
  template<typename DataType_>
  std::pair<int, int> CachedCosinusGeneratorFilter<DataType_>::set_frequency() const
  {
