...
namespace ATK
{
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createOffsetVolumeFilter<double, 2>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createOffsetVolumeFilter<float, 4>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createOffsetVolumeFilter<double, 4>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createOffsetVolumeFilter<float, 8>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createOffsetVolumeFilter<double, 8>(std::size_t)));
}
