...
namespace ATK
{
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createMaxFilter<double, 2>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createMaxFilter<float, 4>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createMaxFilter<double, 4>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createMaxFilter<float, 8>(std::size_t)),
    (template ATK_TOOLS_EXPORT std::unique_ptr<BaseFilter> createMaxFilter<double, 8>(std::size_t)));
}
