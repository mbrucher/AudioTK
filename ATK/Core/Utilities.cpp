...
namespace
{
  ...
  typename boost::disable_if<typename boost::mpl::equal<typename boost::mpl::vector<DataType1>::type, typename boost::mpl::vector<DataType2>::type>::type, void>::type
      convert_to_array(const DataType1* input_array, DataType2* output_array, std::int64_t size, int offset, int ports)
  {
    for(int i = 0; i < size; ++i)
    {
...
{
  template<typename DataType1, typename DataType2>
  void ConversionUtilities<DataType1, DataType2>::convert_array(const DataType1* input_array, DataType2* output_array, std::int64_t size, int offset, int ports)
  {
