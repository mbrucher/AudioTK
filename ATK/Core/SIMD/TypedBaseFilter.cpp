...
namespace ATK
{
  template class TypedBaseFilter<simdpp::float64<2> >;
  ...
  template class TypedBaseFilter<double, simdpp::float64<2> >;
  ...
  template class TypedBaseFilter<simdpp::float64<2>, double>;
