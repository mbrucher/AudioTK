...
namespace ATK
{
  ...
  template<typename DataType_>
  void AllPassFilter<DataType_>::set_blend(DataType_ blend)
  {
    this->blend = blend;
  }

  template<typename DataType_>
  DataType_ AllPassFilter<DataType_>::get_blend() const
  {
    return blend;
  }
  ...
  template<typename DataType_>
  void AllPassFilter<DataType_>::set_feedforward(DataType_ feedforward)
  {
    this->feedforward = feedforward;
  }

  template<typename DataType_>
  DataType_ AllPassFilter<DataType_>::get_feedforward() const
  {
    return feedforward;
  }

  template<typename DataType_>
  void AllPassFilter<DataType_>::full_setup()
  {
