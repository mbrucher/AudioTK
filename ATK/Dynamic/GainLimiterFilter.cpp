...
namespace ATK
{
  ...
  :Parent(nb_channels, nb_channels), threshold(1), softness(static_cast<DataType>(.0001)), LUTsize(LUTsize), LUTprecision(LUTprecision)
  {
  ...
  template<typename DataType_>
  void GainLimiterFilter<DataType_>::process_impl(std::int64_t size) const
  {
