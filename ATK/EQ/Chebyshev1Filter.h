...
namespace ATK
{
  ...
  public:
    Chebyshev1LowPassCoefficients(int nb_channels);
  ...
  public:
    Chebyshev1HighPassCoefficients(int nb_channels);
  ...
  public:
    Chebyshev1BandPassCoefficients(int nb_channels);
  ...
  public:
    Chebyshev1BandStopCoefficients(int nb_channels);
