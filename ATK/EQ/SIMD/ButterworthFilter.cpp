...
namespace ATK
{
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    ...
    (template std::unique_ptr<BaseFilter> createLowPassButterworthFilter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassButterworthFilter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassButterworthFilter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassButterworthFilter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassButterworthFilter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassButterworthFilter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassButterworthFilter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassButterworthFilter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassButterworthFilter<double, 8>(std::size_t)),
