...
namespace ATK
{
  template ATK_EQSIMD_EXPORT FourthOrderBaseCoefficients<simdpp::float64<2> >::FourthOrderBaseCoefficients(std::size_t);
  ...
  template ATK_EQSIMD_EXPORT FourthOrderBaseCoefficients<simdpp::float32<4> >::FourthOrderBaseCoefficients(std::size_t);
  ...
  template ATK_EQSIMD_EXPORT FourthOrderBaseCoefficients<simdpp::float64<4> >::FourthOrderBaseCoefficients(std::size_t);
  ...
  template ATK_EQSIMD_EXPORT FourthOrderBaseCoefficients<simdpp::float32<8> >::FourthOrderBaseCoefficients(std::size_t);
  ...
  template ATK_EQSIMD_EXPORT FourthOrderBaseCoefficients<simdpp::float64<8> >::FourthOrderBaseCoefficients(std::size_t);
