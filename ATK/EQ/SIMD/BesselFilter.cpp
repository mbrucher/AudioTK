...
namespace ATK
{
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    (template std::unique_ptr<BaseFilter> createLowPassBesselFilter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassBesselFilter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassBesselFilter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandStopBesselFilter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassBesselTDF2Filter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassBesselTDF2Filter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandPassBesselTDF2Filter<double, 2>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createBandStopBesselTDF2Filter<double, 2>(std::size_t)),
