...
namespace ATK
{
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    ...
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<double, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<float, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<double, 4>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<float, 8>(std::size_t)),
    (template std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<double, 8>(std::size_t)));
}
