...
namespace ATK
{
  ...
  namespace SIMDPP_ARCH_NAMESPACE
  {
    ...
    std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter(std::size_t nb_channels)
    {
    ...
    template<typename DataType, std::size_t VL>
    std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter(std::size_t nb_channels)
    {
  ...
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createLowPassLinkwitzRileyFilter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createHighPassLinkwitzRileyFilter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createLowPassLinkwitzRiley4Filter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createHighPassLinkwitzRiley4Filter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createLowPassLinkwitzRileyTDF2Filter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createHighPassLinkwitzRileyTDF2Filter) ((std::size_t) nb_channels))
  SIMDPP_MAKE_DISPATCHER((template<typename DataType, std::size_t VL>) (<DataType, VL>) (std::unique_ptr<BaseFilter>) (createLowPassLinkwitzRiley4TDF2Filter) ((std::size_t) nb_channels))
  ...
  SIMDPP_INSTANTIATE_DISPATCHER(
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<double, 2>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyFilter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyFilter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4Filter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4Filter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRileyTDF2Filter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRileyTDF2Filter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createLowPassLinkwitzRiley4TDF2Filter<double, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<float, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<double, 4>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<float, 8>(std::size_t)),
    (template ATK_EQSIMD2_EXPORT std::unique_ptr<BaseFilter> createHighPassLinkwitzRiley4TDF2Filter<double, 8>(std::size_t)));
}
