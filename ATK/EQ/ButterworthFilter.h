...
namespace ATK
{
  ...
  public:
    ButterworthLowPassCoefficients(int nb_channels);
  ...
  public:
    ButterworthHighPassCoefficients(int nb_channels);
  ...
  public:
    ButterworthBandPassCoefficients(int nb_channels);
  ...
  public:
    ButterworthBandStopCoefficients(int nb_channels);
