...
namespace
{
  ...
  void create_chebyshev2_analog_coefficients(size_t order, DataType ripple, std::vector<std::complex<DataType> >& z, std::vector<std::complex<DataType> >& p, DataType& k)
  {
