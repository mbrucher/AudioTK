...
namespace ATK
{
  ...
  class TubeFilter<DataType_>::TubeFunction
  {
    const DataType_ dt;
  ...
  TubeFilter<DataType>::TubeFilter()
    :Parent(1, 5)
  {
  ...
  {
    Parent::setup();
    optimizer.reset(new VectorizedNewtonRaphson<TubeFunction, 4, 10, true>(TubeFunction(static_cast<DataType>(1. / input_sampling_rate))));
  }
